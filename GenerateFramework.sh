...
for PLATFORM in "iOS" "iOS Simulator"; do
    ...
    then
        ...
        echo "From: $SWIFT_MODULE_PATH"
        echo "To: $MODULES_PATH"
        echo
...
# cp -r .build/Build/Intermediates.noindex/ArchiveIntermediates/VSPositionKit/BuildProductsPath/Release-iphoneos/VSPositionKit.swiftmodule Release-iphoneos.xcarchive/Products/usr/local/lib/VSPositionKit.framework/Modules/VSPositionKit.swiftmodule

#xcodebuild -create-xcframework \
#-framework Release-iphoneos.xcarchive/Products/usr/local/lib/VSPositionKit.framework \
#-framework Release-iphonesimulator.xcarchive/Products/usr/local/lib/VSPositionKit.framework \
#-output VSPositionKit.xcframework
