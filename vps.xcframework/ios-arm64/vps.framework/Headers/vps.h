...
@interface VpsAttackDetectionFilter : VpsBase
...
@property (class, readonly) VpsDataType *cn0Average __attribute__((swift_name("cn0Average")));
...
@property (class, readonly) VpsDataType *numSatsUsed __attribute__((swift_name("numSatsUsed")));
...
@property (class, readonly) VpsDataType *fixSuccesful __attribute__((swift_name("fixSuccesful")));
@property (class, readonly) VpsDataType *uniqueSatellitesDetected __attribute__((swift_name("uniqueSatellitesDetected")));
@property (class, readonly) VpsDataType *uniqueSatellitesPerBand __attribute__((swift_name("uniqueSatellitesPerBand")));
...
- (instancetype)initWithDt:(double)dt rVar:(double)rVar rVelVar:(double)rVelVar qv:(double)qv sigmaU:(double)sigmaU cvBlend:(double)cvBlend qs:(double)qs qtheta:(double)qtheta blendTimeout:(double)blendTimeout gnssTrust:(double)gnssTrust trustFall:(double)trustFall trustRise:(double)trustRise minTrust:(double)minTrust maxRInflation:(double)maxRInflation maxPosStep:(double)maxPosStep maxVelStep:(double)maxVelStep gateProb:(double)gateProb positionEngineRepository:(id<VpsPositionEngineRepository>)positionEngineRepository mahalanobisDistanceMultiplierThreshold:(double)mahalanobisDistanceMultiplierThreshold __attribute__((swift_name("init(dt:rVar:rVelVar:qv:sigmaU:cvBlend:qs:qtheta:blendTimeout:gnssTrust:trustFall:trustRise:minTrust:maxRInflation:maxPosStep:maxVelStep:gateProb:positionEngineRepository:mahalanobisDistanceMultiplierThreshold:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
...
- (instancetype)initWithPositionEngineRepository:(id<VpsPositionEngineRepository>)positionEngineRepository params:(VpsMagnetometerDriftEstimatorParams *)params listener:(void (^ _Nullable)(VpsInputSignal *))listener __attribute__((swift_name("init(positionEngineRepository:params:listener:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
 ...
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
- (VpsDouble * _Nullable)brute __attribute__((swift_name("brute()")));
...
- (instancetype)initWithPositionEngineRepository:(id<VpsPositionEngineRepository>)positionEngineRepository params:(VpsMagnetometerDriftEstimatorParams *)params listener:(void (^ _Nullable)(VpsInputSignal *))listener floorLevelHandler:(VpsFloorLevelHandler *)floorLevelHandler __attribute__((swift_name("init(positionEngineRepository:params:listener:floorLevelHandler:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithPositionEngineRepository:(id<VpsPositionEngineRepository>)positionEngineRepository params:(VpsMagnetometerDriftEstimatorParams *)params listener:(void (^ _Nullable)(VpsInputSignal *))listener __attribute__((swift_name("init(positionEngineRepository:params:listener:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (void)doComputeNanoTimestamp:(int64_t)nanoTimestamp systemTimestamp:(int64_t)systemTimestamp __attribute__((swift_name("doCompute(nanoTimestamp:systemTimestamp:)")));
@property (readonly) VpsFloorLevelHandler *floorLevelHandler __attribute__((swift_name("floorLevelHandler")));
@end
...
@property (readonly) VpsFloat * _Nullable northOptimizerStartAngleTolerance __attribute__((swift_name("northOptimizerStartAngleTolerance")));
@property (readonly) int32_t numSimilarDriftEstimatesToTriggerBackTrack __attribute__((swift_name("numSimilarDriftEstimatesToTriggerBackTrack")));
@property (readonly) float queueFillThreshold __attribute__((swift_name("queueFillThreshold")));
@property (readonly) int32_t sensorBufferSize __attribute__((swift_name("sensorBufferSize")));
...
- (instancetype)initWithMlLocation:(VpsLocation *)mlLocation gnssLocation:(VpsLocation *)gnssLocation osProvidedLocation:(VpsLocation *)osProvidedLocation __attribute__((swift_name("init(mlLocation:gnssLocation:osProvidedLocation:)"))) __attribute__((objc_designated_initializer));
...
- (instancetype)initWithSystemTimestamp:(int64_t)systemTimestamp nanoTimestamp:(int64_t)nanoTimestamp position:(VpsCoordinateF *)position floorLevelId:(int64_t)floorLevelId rawMagnetometerWindow:(NSArray<VpsMagMappingRawSensorPack *> *)rawMagnetometerWindow magnetometerBias:(VpsKotlinFloatArray *)magnetometerBias magnetometerAngleCorrection:(float)magnetometerAngleCorrection magnetometerLoss:(float)magnetometerLoss navigationFrameTransform:(VpsKotlinDoubleArray * _Nullable)navigationFrameTransform __attribute__((swift_name("init(systemTimestamp:nanoTimestamp:position:floorLevelId:rawMagnetometerWindow:magnetometerBias:magnetometerAngleCorrection:magnetometerLoss:navigationFrameTransform:)"))) __attribute__((objc_designated_initializer));
...
- (VpsOutputSignalMagnetometerMapData *)doCopySystemTimestamp:(int64_t)systemTimestamp nanoTimestamp:(int64_t)nanoTimestamp position:(VpsCoordinateF *)position floorLevelId:(int64_t)floorLevelId rawMagnetometerWindow:(NSArray<VpsMagMappingRawSensorPack *> *)rawMagnetometerWindow magnetometerBias:(VpsKotlinFloatArray *)magnetometerBias magnetometerAngleCorrection:(float)magnetometerAngleCorrection magnetometerLoss:(float)magnetometerLoss navigationFrameTransform:(VpsKotlinDoubleArray * _Nullable)navigationFrameTransform __attribute__((swift_name("doCopy(systemTimestamp:nanoTimestamp:position:floorLevelId:rawMagnetometerWindow:magnetometerBias:magnetometerAngleCorrection:magnetometerLoss:navigationFrameTransform:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int64_t floorLevelId __attribute__((swift_name("floorLevelId")));
...
@interface VpsOutputSignalUserInfo : VpsOutputSignal
...
- (instancetype)initWithTimestamp:(int64_t)timestamp message:(NSString *)message attacks:(NSArray<VpsGNSSAttack *> *)attacks __attribute__((swift_name("init(timestamp:message:attacks:)"))) __attribute__((objc_designated_initializer));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithTimestamp:(int64_t)timestamp message:(NSString *)message isReady:(BOOL)isReady __attribute__((swift_name("init(timestamp:message:isReady:)"))) __attribute__((objc_designated_initializer));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithTimestamp:(int64_t)timestamp message:(NSString *)message exception:(VpsKotlinException * _Nullable)exception error:(VpsKotlinError * _Nullable)error stacktrace:(NSString * _Nullable)stacktrace __attribute__((swift_name("init(timestamp:message:exception:error:stacktrace:)"))) __attribute__((objc_designated_initializer));
- (NSString *)description __attribute__((swift_name("description()")));
...
+ (NSArray<VpsKotlinDoubleArray *> *)plus:(NSArray<VpsKotlinDoubleArray *> *)receiver other:(NSArray<VpsKotlinDoubleArray *> *)other __attribute__((swift_name("plus(_:other:)")));
